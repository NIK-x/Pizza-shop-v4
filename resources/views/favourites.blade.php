...
<body>
    <header class="header">
        ...
        <div class="header__buttons">
            <a href="{{ url('/') }}" class="header__home-btn" aria-label="Перейти на главную страницу" title="Перейти на главную страницу"><img src="{{ asset('icons/Home.svg') }}" loading="lazy" alt="" width="40" height="40"></a>
            <button type="button" class="header__clean-btn" aria-label="Очистить корзину" title="Очистить корзину" data-js-button-clean><img src="{{ asset('icons/trash.svg') }}" loading="lazy" alt="" width="40" height="40"></button>
        </div>
    </header>
    <main class="main">
        <section class="main__favourites-pizza">
            <article class="main__favourites-pizza-card">
                <div class="main__wrapper">
                    <img src="{{ asset('images/argentina-pizza.png') }}" loading="lazy" alt="" class="main__pizza-img" width="200" height="200">
                    <div class="main__container">
                        ...
                        <div class="main__content">
                            ...
                            <div class="main__quantity-content">
                                <button type="button" class="main__add-pizza" title="Убрать одну пиццу" aria-label="Убрать одну пиццу" data-js-button-add><img src="{{ asset('icons/add-icon.svg') }}" class="main__add-pizza-svg" loading="lazy" alt="" width="25" height="25"></button>
                                <p class="main__quantity" data-js-count>1</p>
                                <button type="button" class="main__reduce-pizza" title="Убрать одну пиццу" aria-label="Убрать одну пиццу" data-js-button-reduce><img src="{{ asset('icons/remove-icon.svg') }}" class="main__reduce-pizza-svg" loading="lazy" alt="" width="25" height="25"></button>
                            </div>
                        </div>
                    </div>
                </div>
